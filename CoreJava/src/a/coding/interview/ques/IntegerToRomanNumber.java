...
public class IntegerToRomanNumber {
	...
	public static void main(String[] args) {
		System.out.println("399 -> "+getRomanEquivalentOfInteger(399));
		System.out.println("499 -> "+getRomanEquivalentOfInteger(499));
		System.out.println("100 -> "+getRomanEquivalentOfInteger(100));
	}
