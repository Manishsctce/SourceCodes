...
class ChildClass extends ParentClass{
	//return type of overridden method should be same.
	//ParentClass : void method1
//	int method1(){		
//	}
	
	
	//PC: int method2(){  //could not be more restrictive
	public int method2(){
		return 0;
	}
...
public class MOR_returnType_modifier {
