...
public class SOAPPublisherClient {
	...
	public static void main(String[] args) throws MalformedURLException, WSException {
		...
		Address addr = new Address("Sai Vatika", "Pune", "MH", "India", 411015l);
		//add person
		System.out.println("Add Person Status="+ps.addPerson(p1,addr));
